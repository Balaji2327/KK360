...
class _ClassChatTabState extends State<ClassChatTab> {
  ...
  Future<void> _loadChatRoom() async {
    try {
      ...
      if (classRoom != null) {
        await _chatService.clearExpiredPins(chatRoomId: classRoom.id);
  ...
  void _showReactionBar(Message message, Offset globalPosition) {
    ...
    final double dx = (globalPosition.dx - barWidth / 2)
      .clamp(12.0, size.width - barWidth - 12.0)
      .toDouble();
    final double dy = (globalPosition.dy - barHeight - 12)
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    ...
                                    onTap:
                                        _hasSelection ? _clearSelection : null,
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(
                                        vertical: h * 0.01,
                                      ),
