...
class _StudentChatPageState extends State<StudentChatPage> {
  ...
  Future<void> _showMoreMenu() async {
    ...
    final selected = await showMenu<String>(
      ...
      items: [
        ...
        if (message.senderId == _userId && !message.isDeleted)
  ...
  List<Message> _getDisplayMessages() {
    return _messages;
  }
        ...
        children: [
                    ...
                    : Column(
                      children: [
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final message = _getDisplayMessages()[index];
                        ...
                        return GestureDetector(
                          behavior: HitTestBehavior.translucent,
                          onLongPressStart: (details) => _onMessageLongPress(
                            message,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildReactionsRow(message, isCurrentUser),
                              ],
                            ),
                          ),
                        );
          ...
          if (_chatRoom != null)
            Container(
              ...
              padding: EdgeInsets.all(w * 0.04),
              child:
                  _chatRoom!.permissions.canSendMessages('student')
                      ? Row(
                        children: [
                          Expanded(
                            child: TextField(
