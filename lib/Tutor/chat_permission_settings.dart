...
class TutorChatPermissionSettingsPage extends StatefulWidget {
  final String chatRoomId;
  final String className;

  const TutorChatPermissionSettingsPage({
    super.key,
  ...
  @override
  State<TutorChatPermissionSettingsPage> createState() =>
      _TutorChatPermissionSettingsPageState();
}

class _TutorChatPermissionSettingsPageState
    extends State<TutorChatPermissionSettingsPage> {
