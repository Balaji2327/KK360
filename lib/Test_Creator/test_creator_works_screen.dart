...
class TestCreatorWorksScreen extends StatefulWidget {
  final String? classId;
  final String? className;

  const TestCreatorWorksScreen({super.key, this.classId, this.className});

  @override
  State<TestCreatorWorksScreen> createState() => _TestCreatorWorksScreenState();
}

class _TestCreatorWorksScreenState extends State<TestCreatorWorksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Removed SafeArea to allow header to go behind status bar
      body: Column(
        children: [
          // ------------ HEADER ------------
          Container(
                      ...
                      onTap:
                          () => goPush(
                            ...
                            widget.classId != null
                                ...
                                : const TestCreatorClassChatSelection(),
                          ),
                      child: featureTile(
                        w,
                        h,
